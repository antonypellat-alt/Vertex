...
def render_dashboard(gpx_bytes: bytes, filename: str):
    # UX-KAI : retour en haut de page automatique à chaque rendu du dashboard
    components.html(
        "<script>setTimeout(function(){ window.parent.scrollTo({top: 0, behavior: 'instant'}); }, 200);</script>",
        height=1,
    )
