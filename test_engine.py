...
test("B6 · ratio=0.95 → PROFIL ENDURANCE",
     classify_profile(0.95, 3.0) == "PROFIL ENDURANCE", "")

# B7 : profil EXPLOSIF
test("B7 · ratio=0.88 → PROFIL EXPLOSIF",
     classify_profile(0.88, 3.0) == "PROFIL EXPLOSIF", "")

# B8 : profil FRAGILE
test("B8 · ratio=0.80 → PROFIL FRAGILE",
     classify_profile(0.80, 3.0) == "PROFIL FRAGILE", "")

# B9 : profil INCONNU sur NaN
test("B9 · ratio=NaN → PROFIL INCONNU",
     classify_profile(float('nan'), 3.0) == "PROFIL INCONNU", "")
